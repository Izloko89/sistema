...
$(document).ready(function(e) {
	...
	$(".metodo").change(function(e) {
        ...
        if($(this).find("option:selected").val()=="credito"){
			$(".divplazos").show();
		}else if($(this).find("option:selected").val()=="transferencia" || $(this).find("option:selected").val()=="cheque" || $(this).find("option:selected").val()=="tc" || $(this).find("option:selected").val()=="td"){
			$(".divbancos").show();
		}
    });
});
