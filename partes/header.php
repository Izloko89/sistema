    	...
    	<div align="center">
          <div class="fondo_azul linea_abajo_azul">
			...
			/*
				...
				{
			?>
              <span class="celda link" data-url="cotizaciones.php">COTIZACIONES</span><?php }?>
			<?php 
				if($_SESSION['evento'] == 1)
				{
			?>
              <span class="celda link" data-url="eventos.php">EVENTOS</span><?php }?>
			<?php 
				if($_SESSION['almacen'] == 1)
				{
			?>
              <span class="celda link" data-url="almacen.php">ALMACEN</span><?php }?>
			<?php 
				if($_SESSION['compras'] == 1)
				{
			?>
              <span class="celda link" data-url="compras.php">COMPRAS</span><?php }?>
			<?php 
				if($_SESSION['bancos'] == 1)
				{
			?>
				<span class="celda link" data-url="bancos.php">BANCOS</span><?php }?>
			<?php 
				if($_SESSION['gastos'] == 1)
				{
			?>
              <span class="celda link" data-url="gastos.php">GASTOS</span><?php }?>
			<?php 
				if($_SESSION['modulos'] == 1)
				{
			?>
              <span class="celda link" data-url="modulos.php">MÓDULOS</span><?php } */ ?>
            <span class="celda link" data-url="cotizaciones.php">ADMINISTRACION</span>
            <span class="celda link" data-url="licitaciones.php">LICITACIONES</span>
            <span class="celda link" data-url="ventas.php">VENTAS</span>
            <span class="celda link" data-url="grupos.php">GRUPOS</span>
			<span class="celda link" data-url="compras.php">COMPRAS</span>
            <span class="celda link" data-url="operaciones.php">OPERACIONES</span><br>
            <span class="celda link" data-url="auditoria.php">AUDITORIA</span>
            <span class="celda link" data-url="almacen.php">ALMACEN</span>
            <span class="celda link" data-url="facturacion.php">FACTURACION</span>
            <span class="celda link" data-url="modulos.php">MODULOS</span>
            </div>
          </div>
          <div class="fondo_gris linea_abajo_gris">
              ...
              <div class="celda mitad" align="left">
                <div class="tabla" style="height:100%;">
                  <img class="imgCCE" src="img/logo.png" height="50%" width="70%"/>
                <?php if($logo2!=""){ ?>
