...
try{
	...
	//sacar los campos para hacerlo más autoámtico	
	$sqlArt="SELECT 
	...
	foreach($res->fetchAll(PDO::FETCH_ASSOC) as $v){
		$precios='<select id="comboPrecio" class="precios" onchange="cToT(this);" style="margin-right:3px; width:87px;">
		...
		</select><input type="text" id="textPrecio" class="precio" onkeyup="darprecio(this)"/>';
