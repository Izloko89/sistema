...
<table style="width:100%;border-bottom:'.pxtomm(2).' solid #000;" cellpadding="0" cellspacing="0" >
    <tr>
      ...
      <p style="width:100%; text-align:center; margin:5px auto; font-size:10px;">&nbsp;</p></td>
...
<table style="width:100%; margin-top:5px;">
  <tr>
    ...
    <td style="width:30%;font-size:12px;"><u>'.varFechaAbr($fechaEve).'</u></td>
    <td style="width:15%;font-size:12px;">Lugar de evento:</td>
    <td style="width:25%;font-size:12x;"><u>'.$salon["nombre"].'</u></td>
  </tr>
  <tr>
    <td style="width:20%;font-size:12px;">Nombre de cliente:</td>
    <td style="width:30%;font-size:12px;"><u>'.$cliente.'</u></td>
	<td style="width:15%;font-size:12px;">Domicilio</td>
	<td style="width:25%;font-size:12px;"><u>'.$salon["direccion"].'</u></td>
  </tr><tr>
  <td style="width:20%;font-size:12px;">Evento</td>
  <td style="width:30%;font-size:12px;"><u>'.$nombreEve.'</u></td>
</tr>
</table>

<table cellpadding="0" cellspacing="0" style=" font-size:12px;width:100%; margin-top:5px;">
	<tr>
    	<td style="width:20%; font-size:12px;">Fecha de entrega:</td>
        <td style="width:80%; font-size:10px;"><div style="margin-left:5px; border-bottom:1px solid #000;"><input style="width:100%; border:0;" type="text" value="'.varFechaExtensa($evento["fechamontaje"]).' a '.date("h:i a",strtotime($evento["fechamontaje"])+7200).'" /></div></td>
    </tr><tr>
        <td style="width:20%; font-size:12px;">Fecha para recoger:</td>
        <td style="width:80%; font-size:10px;"><div style="margin-left:5px; border-bottom:1px solid #000;"><input style="width:100%; border:0;" type="text" value="'.varFechaExtensa($evento["fechadesmont"]).' a '.date("h:i a",strtotime($evento["fechadesmont"])+7200).'" /></div></td>
    </tr>
</table>
<table style="width:100%; margin-top:5px;">
<tr>
      <td style="width:15%; text-align:left;font-size:12px;">Encargado:</td>
      <td style="width:35%; text-align:left;font-size:10px;"><u>' . $_GET["encargado"] . '</u></td>
      <td style="width:15%; text-aling:right;font-size:12px;">Montan:</td>
      <td style="width:35%; text-align:left;font-size:10px;"><u>' . $_GET["monta"] . '</u></td>
    </tr>
    <tr>
      <td style="width:15%; text-align:left;font-size:12px;">Unidad utilizada:</td>
      <td style="width:35%;text-aling:left;font-size:10px;"><u>' . $_GET["unidad"] . '</u></td>
    </tr>
</table>
...
Debo y pagare a la orden de BARICONCEPT.S.A. de C.V.  En esta ciudad de Guadalajara, Jal., el día <u>'.varFechaAbr($fechaEve).'</u> La cantidad de ______________
</div>
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
