...
<table style="width:100%; margin-top:5px;">
  <tr>
    <td style="width:15%; font-size:12px;">Fecha de evento:</td>
    <td style="width:35%;font-size:10px;"><u>'.varFechaAbr($fechaEve).'</u></td>
    <td style="width:15%;font-size:12px;">Lugar de evento:</td>
    <td style="width:35%;font-size:10x;"><u>'.$domicilio.'</u></td>
  </tr>
  <tr>
    <td style="width:15%;font-size:12px;">Nombre de cliente:</td>
    <td style="width:35%;font-size:10px;"><u>'.$cliente.'</u></td>
  </tr><tr>
  <td style="width:15%;font-size:12px;">Domicilio</td>
  <td style="width:35%;font-size:10px;"><u>'.$domicilio.'</u></td>
</tr>
</table>

<table cellpadding="0" cellspacing="0" style=" font-size:11px;width:100%; margin-top:5px;">
	<tr>
    	<td style="width:15%; font-size:12px;">Fecha de entrega:</td>
        ...
        <td style="width:15%; font-size:12px;">Fecha para recoger:</td>
...
Debo y pagare a la orden de BARICONCEPT.S.A. de C.V.  En esta ciudad de Guadalajara, Jal., el día <u>'.varFechaAbr($fechaEve).'</u> La cantidad de $'.number_format($total,2).'
</div>
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
