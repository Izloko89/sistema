...
Contrato de servicio que celebran por una parte BARI Concept representada por Fabiola Alférez Serur y por la otra '.utf8_encode($cliente).' en representación de ella misma quien en lo sucesivo se denominará en el cuerpo del presente instrumento como el CONTRATADO y el CONTRATANTE  respectivamente de conformidad con las siguientes:
</div>
<br/>
...
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
Declara el contratante tener su domicilio en'. $domicilio .' y que el evento para el cual contrata los servicios del contratado se realizará el día '.$fechaEve.' en '.$domicilio.'con horario de entrega a las</div>
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
...
<br/>
<br/>
<div style="width:100%; padding:5 20px; text-align:center; font-size:10px;">1.	El contratante contrata los siguientes elementos para la decoración de su evento en renta.</div>
...
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
<strong>5.</strong>En caso de existir algún daño o faltante en el equipo, éste lo pagará el contratado a precio de costo de reposición del  equipo señalado. Se deberá dejar un depósito de CANTIDAD DE DEPOSITO por faltantes o daños que en caso de no requerirse se devolverá al finalizar el evento.</div>
<div style="width:100%; padding:5 20px; font-size:10px;text-align:justify;">
